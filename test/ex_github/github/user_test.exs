...
defmodule UserTest do
  ...
  test "following status" do
    assert User.following?(Mock.User, "ortuna", "elixir") == true 
    assert User.following?(Mock.User, "ortuna", "php")    == false
  end

  test "follow a user" do
    assert User.follow(Mock.User, "12345abc", "elixir") == true
    assert User.follow(Mock.User, "12345abc", "php")    ==  false
  end

  test "unfollow a user" do
    assert User.unfollow(Mock.User, "12345abc", "php") == true
  end

  test "can fetch current users emails" do
    emails = User.emails(Mock.User, "12345abc")
